...
import { Card, Table, Form } from 'lanlinker';
...
export default () => {
  ...
  return (
    <Row className={styles.projectInfo}>
      <Card title="工程名称" className={styles.left}>
        <Card
        ...
        >
          <img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1583396027927&di=e47623db0610865d1f5f447253f45496&imgtype=0&src=http%3A%2F%2Fuploads.oh100.com%2Fallimg%2F1709%2F145-1F919111228.jpg"></img>
        </Card>
        <Card
          className={styles.imgCard}
          bodyStyle={{ padding: 0 }}
        ...
        >
          <img
            src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1583396027927&di=e47623db0610865d1f5f447253f45496&imgtype=0&src=http%3A%2F%2Fuploads.oh100.com%2Fallimg%2F1709%2F145-1F919111228.jpg"
            style={{ maxWidth: 790, maxHeight: 630 }}
          ></img>
        </Modal>
      </Card>
      <Card
          ...
          <TabPane key="五方责任主体基本信息" tab="五方责任主体基本信息">
            <Tabs type="card">
              <TabPane key="承建单位" tab="承建单位">
                ...
                ></License>
                <Form className={styles.licenseExtra} columns={2}>

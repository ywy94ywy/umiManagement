...
import { ACCOUNT_TYPE, USER_TYPE_LIST, USER_TYPE } from '@/config/enum';
...
export default () => {
  ...
  const onSubmit = async () => {
    ...
    if (tab === TABS[0]) {
      ...
      const data = {
        ...
        registerType: ACCOUNT_TYPE.MOBILE,
      };
  ...
  return (
    <>
      ...
      <Form
        form={infoForm}
        initialValues={{ type: USER_TYPE.PERSON.KEY }}
        {...formProps}
      >
        <Form.Item
          name="type"
